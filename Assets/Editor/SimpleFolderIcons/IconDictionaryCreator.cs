...
namespace SimpleFolderIcon.Editor
{
    ...
    {
        private const string AssetsPath = "Editor/SimpleFolderIcons/Icons";
        ...
        internal static void BuildDictionary()
        {
            ...
            {
                var texture = (Texture)AssetDatabase.LoadAssetAtPath($"Assets/Editor/SimpleFolderIcons/Icons/{f.Name}", typeof(Texture2D));
            ...
            {
                var folderIconSO = (FolderIconSO)AssetDatabase.LoadAssetAtPath($"Assets/Editor/SimpleFolderIcons/Icons/{f.Name}", typeof(FolderIconSO));
